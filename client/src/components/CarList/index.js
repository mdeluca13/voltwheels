...
const CarList = ({
  ...
  if (!cars.length) {
    return <h3>No Cars for Sale Yet</h3>;
  }
            ...
            <h4 className="card-header bg-primary text-light p-2 m-0">
              {showUsername ? (
                  <span style={{ fontSize: '1rem' }}>
                    {car.seller} is selling a {car.color} {car.year} {car.make} {car.model} for ${car.price}
                  </span>
                
              ) : (
                <>
                  <span style={{ fontSize: '1rem' }}>
                    You are selling a {car.color} {car.year} {car.make} {car.model} for ${car.price}
                  </span>
                </>
              )}
            </h4>
            <div className="card-body bg-light p-2">
              <p>{car.color} {car.year} {car.make} {car.model}</p>
            </div>
            <Link
